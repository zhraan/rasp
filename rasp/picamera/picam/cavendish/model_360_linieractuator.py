...
model = YOLO("/home/pi/Model/rasp/Model Pisang Cavendish/model 224x224 v4/best_saved_model/best_full_integer_quant_edgetpu.tflite")
...
while True:
    ...
    if frame_result:
        ...
        cv2.imshow("Cam Detection", frame_to_show)
