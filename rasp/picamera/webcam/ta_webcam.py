...
# === Kamera USB Webcam ===
cap = cv2.VideoCapture(0)  # Ganti index jika lebih dari 1 webcam
...
def camera_thread():
    ...
    while running:
        ...
        if not ret:
            continue
        with frame_lock:
            # Jika model Anda butuh RGB, aktifkan baris berikut:
...
while True:
    ...
    if frame_result:
        ...
        # Karena frame disimpan dalam RGB, ubah ke BGR sebelum tampilkan
